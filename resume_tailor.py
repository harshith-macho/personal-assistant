...
5. 100% factual — Harshith's real professional experience is: DevOps Engineer at GenexCorp (Aug 2024 - Aug 2025) and Software Engineer at Cognizant (Jun 2023 - Jun 2024, plus Jan 2023 - Jun 2023), both real paid roles — PLUS current Griffith MSc coursework project work (Oct 2025 - Present) where he gets HANDS-ON EXPOSURE to cloud/DevOps tools, not production-depth mastery. He is still studying toward his first AWS cert (started 2026-07-16). Do NOT invent employers, additional projects, teams, production outcomes, tools/technologies, or facts that aren't in the base resume. ALL dates (MSc: Sep 2025 - Sep 2026, Bachelor's: 2020 - 2024, GenexCorp: Aug 2024 - Aug 2025, Cognizant: Jan 2023 - Jun 2024, project dates: Oct 2025 - Present) must be copied EXACTLY as they appear in the base resume below — never alter, recalculate, or guess a date
...
8. Length: stay close to the base resume's length — roughly 400-550 words, one page. Do not pad to fill a second page. It is fine and expected for this resume to look like what it is: an early-career student resume, not a senior engineer's
   - Keep all real EXPERIENCE entries from the base resume (GenexCorp, Cognizant, Griffith MSc coursework project) — you may select/reorder bullets within each entry to match the JD and may drop an entry's bullets down to the most relevant ones, but do not merge entries together, drop an entire entry, or invent new sub-initiatives
